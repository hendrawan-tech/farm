    ...
    <div class="card">
        <div class="card-body">
            <div style="display: flex; justify-content: space-between;">
                <h4 class="card-title">@lang('crud.sliders.index_title')</h4>
            </div>
            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover">
                    <thead>
                        <tr>
                            <th class="text-left">
                                @lang('crud.sliders.inputs.badge')
                            </th>
                            <th class="text-left">
                                @lang('crud.sliders.inputs.title')
                            </th>
                            <th class="text-left">
                                @lang('crud.sliders.inputs.button')
                            </th>
                            <th class="text-left">
                                @lang('crud.sliders.inputs.link')
                            </th>
                            <th class="text-left">
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="6">{!! $sliders->render() !!}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
