...
class AboutControllerTest extends TestCase
{
     ...
     * @test
     */
    public function it_displays_index_view_with_abouts()
    {
     ...
     * @test
     */
    public function it_displays_create_view_for_about()
    {
     ...
     * @test
     */
    public function it_stores_the_about()
    {
        $data = About::factory()
            ->make()
            ->toArray();
     ...
     * @test
     */
    public function it_displays_show_view_for_about()
    {
     ...
     * @test
     */
    public function it_displays_edit_view_for_about()
    {
        $about = About::factory()->create();
     ...
     * @test
     */
    public function it_updates_the_about()
    {
        $about = About::factory()->create();
     ...
     * @test
     */
    public function it_deletes_the_about()
    {
        $about = About::factory()->create();
